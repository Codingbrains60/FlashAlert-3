...
let appTitle = ""
let webAppUrl = URL(string: "https://flashalert.projects-codingbrains.com/")
let allowedOrigin = "flashalert.projects-codingbrains.com"
...
let navigationBarColor = getColorFromHex(hex: 0xf8f9fa, alpha: 1.0)
let navigationTitleColor = getColorFromHex(hex: 0x212529, alpha: 1.0)
let navigationButtonColor = navigationTitleColor
let progressBarColor = getColorFromHex(hex: 0x000000, alpha: 1.0)
